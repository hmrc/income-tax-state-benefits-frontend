...
object Journey extends Enum[Journey] with PlayJsonEnum[Journey] {
  ...
  case object EmploymentSupportAllowance extends Journey("employment-support-allowance")
  case object JobSeekersAllowance extends Journey("jobseekers-allowance")
}
