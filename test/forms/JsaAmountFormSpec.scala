...
class JsaAmountFormSpec extends UnitTest {


  private def theForm(): Form[BigDecimal] = new FormsProvider().jsaAmountForm()
  ...
  "The AmountForm" should {
    ...
    "invalidate an empty currency" in {
      ...
      emptyTest.errors should contain(FormError(amount, "jobseekers.amountPage.empty.amount.error"))
    }
    ...
    "invalidate currency that includes invalid characters" in {
      ...
      invalidCharTest.errors should contain(FormError(amount, "common.error.invalid_currency_format"))
    }
    ...
    "invalidate a currency that has incorrect formatting" in {
      ...
      invalidFormatTest.errors should contain(FormError(amount, "common.error.invalid_currency_format"))
    }
    ...
    "invalidate a currency that is too big" in {
      ...
      bigCurrencyTest.errors should contain(FormError(amount, "common.error.amountMaxLimit"))
    }
  }
}
