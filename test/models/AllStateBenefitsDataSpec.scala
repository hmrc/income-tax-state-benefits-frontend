...
class AllStateBenefitsDataSpec extends UnitTest {
  ...
  "allStateBenefitsDataWrites" should {
    "convert AllStateBenefitsData to correct JsValue when full object" in {
      Json.toJson(allStateBenefitsData) shouldBe allStateBenefitsDataJsValue
    }
  ...
  "allStateBenefitsDataReads" should {
    "convert JsValue to AllStateBenefitsData when full object" in {
      Json.fromJson[AllStateBenefitsData](allStateBenefitsDataJsValue).get shouldBe allStateBenefitsData
    }
