...
class CustomerAddedStateBenefitsDataSpec extends UnitTest {
  ...
  "customerAddedStateBenefitsDataWrites" should {
    "convert CustomerAddedStateBenefitsData to correct JsValue when full object" in {
      Json.toJson(customerAddedStateBenefitsData) shouldBe aCustomerAddedStateBenefitsDataJsValue
    }
    ...
    "convert CustomerAddedStateBenefitsData to correct JsValue when empty object" in {
      ...
      Json.toJson(CustomerAddedStateBenefitsData()) shouldBe jsValue
    }
  }

  "customerAddedStateBenefitsDataReads" should {
    "convert JsValue to CustomerAddedStateBenefitsData when full object" in {
      Json.fromJson[CustomerAddedStateBenefitsData](aCustomerAddedStateBenefitsDataJsValue).get shouldBe customerAddedStateBenefitsData
    }
    ...
    "convert JsValue to CustomerAddedStateBenefitsData when empty object" in {
      ...
      Json.fromJson[CustomerAddedStateBenefitsData](jsValue).get shouldBe CustomerAddedStateBenefitsData()
    }
  }
}
