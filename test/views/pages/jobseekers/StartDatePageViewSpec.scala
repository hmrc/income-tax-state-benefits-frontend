...
class StartDatePageViewSpec extends ViewUnitTest {
  ...
  object ExpectedIndividualCY extends SpecificExpectedResults {
    ...
    override def expectedMustBeSameAsOrBeforeErrorText(taxYear: Int): String =
      s"The date you started getting Jobseeker’s Allowance must be the same as or before ${translatedTaxYearEndDateFormatter(taxYear)(welshMessages)}"
        .replace("\u00A0", " ")
  ...
  object ExpectedAgentCY extends SpecificExpectedResults {
    ...
    override def expectedMustBeSameAsOrBeforeErrorText(taxYear: Int): String =
      s"The date your client started getting Jobseeker’s Allowance must be the same as or before ${translatedTaxYearEndDateFormatter(taxYear)(welshMessages)}"
        .replace("\u00A0", " ")
