...
class TaxPaidPageViewSpec extends ViewUnitTest {
  ...
  object AgentSpecificExpectedCY extends SpecificExpectedResults {
    ...
    override val expectedErrorText: String = "Nodwch swm y dreth a ddidynnwyd o Lwfans Ceisio Gwaith eich cleient"

    override def expectedHeading(firstDate: LocalDate, secondDate: LocalDate): String = s"Faint o dreth a gafodd ei didynnu o Lwfans Ceisio Gwaith eich cleient rhwng " +
      s"${translatedDateFormatter(firstDate)(welshMessages)} a ${translatedDateFormatter(secondDate)(welshMessages)}?"
        .replace("\u00A0", " ")

    override def expectedTaxExceedsAmountErrorText(amount: BigDecimal): String =
      s"Mae’n rhaid i swm y dreth a ddidynnwyd fod yn llai na swm y Lwfans Ceisio Gwaith a gafodd eich cleient, sef £$amount"
  }
  ...
  object IndividualSpecificExpectedCY extends SpecificExpectedResults {
    ...
    override val expectedErrorText: String = "Nodwch swm y dreth a ddidynnwyd o’ch Lwfans Ceisio Gwaith"
    ...
    override def expectedTaxExceedsAmountErrorText(amount: BigDecimal): String = s"Mae’n rhaid i swm y dreth a ddidynnwyd fod yn llai na swm y Lwfans Ceisio Gwaith a gawsoch, sef £$amount"
  }
